...
import { initAli, detailContent, playContent } from './lib/ali_readable.js';
...
async function requestRaw(reqUrl, headers) {
  ...
  return { content: JSON.stringify(res.content) };
}
...
async function search(wd, quick, pg) {
  ...
  const json = jsonParse(result.content).pageProps.data;
